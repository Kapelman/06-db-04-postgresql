...
root@a72d85c6b712:/var# su - postgres
postgres@a72d85c6b712:~$ psql
...
```
root@a72d85c6b712:/var# chown postgres:postgres /var/db-data/
root@a72d85c6b712:/var# chown postgres:postgres /var/db-backup/
root@a72d85c6b712:/var# ls -al
total 60
...
-- загрузим backup
```
postgres@a72d85c6b712:/var/db-backup$ psql --dbname=test_database --file=test_dump.sql
SET
SET
SET
SET
...
- выгрузим dump
```
postgres@a72d85c6b712:/var/db-backup$ pg_dump test_database > test_database.dmp
postgres@a72d85c6b712:/var/db-backup$ ls -al
total 20
...
postgres@a72d85c6b712:/var/db-backup$ cat test_database.dmp
--
...
postgres@a72d85c6b712:/var/db-backup$ psql --dbname=test_database --file=test_database.dmp
SET
SET
SET
SET
